...
import "swiper/css";
import { newArrivals, topSelling, casual } from "@/data/products-data";
...
function getProductById(id: number): Product | undefined {
  const all = [...newArrivals, ...topSelling, ...casual];
...
export default function ProductPage({
  ...
  return (
    <div className={styles.productDetailContainer}>
      ...
      <div className={styles.suggestSection} style={{ marginTop: 48 }}>
        <h2
          style={{
            textAlign: "center",
            fontWeight: 700,
        ...
        >
          {(() => {
            const allProducts = [...newArrivals, ...topSelling, ...casual];
